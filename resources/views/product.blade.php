                ...
                <div class="flex justify-between">
                    <div class="flex space-x-7">
                        <div>
                            ...
                            <a href="{{ route('home') }}" class="flex items-center py-4 px-2">
                                <img src="Images/logo-display.svg" alt="Logo">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="hidden md:flex items-center space-x-3 ">
                        ...
                        <a id="nav-profile-img" href="profile.html" class="none md:visible"><img
                                ...
                                src='Images/default-profile.jpeg' /></a>
            ...
            <div class="hidden mobile-menu">
                <ul class="">
                    <li id="nav-profile-img-mobile"><a href="profile.html"
                            class="block text-sm px-2 py-4 hover:bg-blue-500 transition duration-300 text-base font-regular">Profile</a>
                    </li>
                    <li><a href="home.html"
                            class="block text-sm px-2 py-4 text-white bg-blue-600 text-base font-regular">Home</a></li>
                    <li><a href="contact.php"
                            class="block text-sm px-2 py-4 hover:bg-blue-600 transition duration-300 text-base font-regular">Contact
                            Us</a></li>
                    <li id="nav-login-btn-mobile"><a href="login.html"
                            class="block text-sm px-2 py-4 hover:bg-blue-500 transition duration-300 text-base font-regular">Log
                            In</a></li>
                    <li id="nav-signup-btn-mobile"><a href="signup.html"
                            class="block text-sm px-2 py-4 hover:bg-blue-500 transition duration-300 text-base font-regular">Sign
                            Up</a></li>
                </ul>
            </div>
            <script>
    ...
    <div>
        <div class="flex pt-5 md:pt-12 justify-center">
            <div class="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
                <div
                    class="md:w-1/2 h-64 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:rounded-bl-lg md:h-auto overflow-hidden">
                    <img id="dish-page-image" class="object-cover" src="{{ $product->image }}" />
                ...
                <div class="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2" style="overflow: scroll">
                    ...
                    <span id="dish-page-prep-time"
                        class="bg-green-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">30 min</span>
                    <span id="dish-page-cuisine-type"
                        class="bg-green-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">{{ $product->category->name }}</span>
                    ...
                    <div class="flex flex-row mt-8">
                        ...
                        <div class="w-8/12 md:w-10/12 ml-2">
                            <h2 id="dish-page-owner-name"
                                class="text-gray-800 text-lg font-medium mb-2 cursor-pointer">Ashutosh Hathidara</h2>
                            <p id="dish-page-owner-caption"
                                class="text-sm font-light text-gray-600 truncate overflow-ellipsis">The Short Symphony,
                                or Symphony No. 2, is a symphony written by the American composer Aaron Copland from
                                1931 to 1933. The name derives from its short length of only 15 minutes. The work is
                                dedicated to Copland's friend, the Mexican composer and conductor Carlos Chávez
                                (pictured). The composition contains complex rhythms and polyharmonies, and incorporates
                                the composer's emerging interest in serialism and Mexican music. Copland later arranged
                                the work as a sextet. The symphony was not widely performed during Copland's</p>
                        </div>
                    </div>
...
<div class=" bg-gray-900">
    ...
    <script type="text/javascript" src='JS/dishPageHandler.js'></script>
